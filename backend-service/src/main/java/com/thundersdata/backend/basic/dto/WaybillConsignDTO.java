...
@ApiModel("托运单DTO")
@Data
public class WaybillConsignDTO  {
    ...
    @ApiModelProperty(value = "发货企业联系人")
    private String shipperContact;

    @ApiModelProperty(value = "发货企业联系电话")
    ...
    @ApiModelProperty(value = "关联货物信息")
    private List<WaybillConsignGoodsDTO> listGoods;
}
